  ...
  const handleLogin = async () => {
    try {
      const response = await axios.post(
        `${import.meta.env.VITE_BACKEND_URI}/api/users/find`,
        {
          name,
          pin,
        },
    ...
    <div className="w-full min-h-screen flex flex-col lg:flex-row items-center justify-center gap-2 p-4 lg:p-8">
      {showcard ? (
        <div className="w-full lg:w-1/2 flex flex-col items-center justify-center perspective ">
          ...
          <Link to={"/homepage"}>
            <button
              className="mt-6  bg-primary flex items-center justify-center p-3 rounded-2xl hover:bg-secondary transition-colors cursor-pointer text-white font-semibold"
        ...
        <div className="w-full lg:w-1/2 flex flex-col gap-3 max-w-md  p-6 lg:p-8 rounded-3xl ">
          ...
          >
            ...
            <button
              type="submit"
              className="w-full mt-5 bg-primary flex items-center justify-center p-3 rounded-2xl hover:bg-secondary transition-colors cursor-pointer text-white font-semibold"
            >
              Login Account
            </button>
          </form>
